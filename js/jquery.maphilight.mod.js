(function($) {
	...
	if(has_canvas) {
		...
		create_canvas_for = function(img) {
			var c = $('<canvas style="display: block; margin-left:'+ margin_left +'px; position: absolute; width:'+img.width+'px;height:'+img.height+'px; z-index: 10;pointer-events: none"></canvas>').get(0);
	...
	$.fn.maphilight = function(opts) {
		...
		return this.each(function() {
			...
			*/
			...
			img.before(wrap).css('opacity', 1).css('z-index', 1).css(canvas_style).remove();
			if(has_VML) {
